...
namespace GameServer
{
    abstract class ServerRoundState
    {
        ...
        {
            int player_index = action.client;
            int tile_ID = (action.action as TileDiscardClientAction).tile;
        ...
        {
            int player_index = action.client;
            bool open = (action.action as RiichiClientAction).open;
        ...
        {
            int player_index = action.client;
            int tile_ID = (action.action as LateKanClientAction).tile;
        ...
        {
            int player_index = action.client;
            TileType type = (action.action as ClosedKanClientAction).tile_type;
        ...
        {
            int player_index = action.client;
            int tile_1_ID = (action.action as ChiiClientAction).tile_1;
            int tile_2_ID = (action.action as ChiiClientAction).tile_2;
    ...
    class RegularServerRoundState : ServerRoundState
    {
        ...
        public RegularServerRoundState(ServerSettings settings, Wind round_wind, int dealer, int wall_index, Random rnd, bool[] can_riichi, AnimationTimings timings)
        {
    ...
    class LogServerRoundState : ServerRoundState
    {
        ...
        public LogServerRoundState(ServerSettings settings, Wind round_wind, int dealer, Random rnd, bool[] can_riichi, AnimationTimings timings, GameLogRound round)
        {
