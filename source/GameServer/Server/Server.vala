...
namespace GameServer
{
    abstract class Server : Object
    {
        ...
        public Server(ArrayList<ServerPlayer> players, ArrayList<ServerPlayer> spectators, Random rnd, GameStartInfo start_info, ServerSettings settings)
        {
            this.rnd = rnd;
    ...
    class RegularServer : Server
    {
        ...
        public RegularServer(ArrayList<ServerPlayer> players, ArrayList<ServerPlayer> spectators, Random rnd, GameStartInfo info, ServerSettings settings)
        {
    ...
    class LogServer : Server
    {
        ...
        public LogServer(ArrayList<ServerPlayer> spectators, Random rnd, ServerSettings settings, GameLog log)
        {
