...
namespace GameServer
{
    abstract class ServerGameRound // Signal receiver needs to be object
    {
        ...
        public ServerGameRound(RoundStartInfo info)
        {
            this.info = info;
        }
    ...
    class RegularServerGameRound : ServerGameRound
    {
        ...
        public RegularServerGameRound(RoundStartInfo info, ServerSettings settings, ArrayList<ServerPlayer> players, ArrayList<ServerPlayer> spectators, Wind round_wind, int dealer, Random rnd, bool[] can_riichi, AnimationTimings timings)
        {
            base(info);
    ...
    class LogServerGameRound : ServerGameRound
    {
        ...
        public LogServerGameRound(ServerSettings settings, ArrayList<ServerPlayer> players, ArrayList<ServerPlayer> spectators, Wind round_wind, int dealer, Random rnd, bool[] can_riichi, AnimationTimings timings, GameLogRound log_round)
        {
